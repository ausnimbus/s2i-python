...
node {
        ...
        */
        ...
        def testApp = openshift.newApp("s2i-python:${tag}~https://github.com/ausnimbus/python-ex", "-l app=python-ex");
        ...
        openshift.tag("ausnimbus-ci/s2i-python:${tag}", "ausnimbus-staging/s2i-python:${tag}")
}
